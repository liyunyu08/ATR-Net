...
def parse_args(arg_mode):
    ...
    ''' about dataset '''
    parser.add_argument('-dataset', type=str, default='cub',  choices=['flowers','aircraft','cars','dogs','miniimagenet', 'cub', 'tieredimagenet', 'cifar_fs'])
    parser.add_argument('-data_dir', type=str, default='../renet/datasets', help='dir of datasets')
    ...
    parser.add_argument('-method', type=str, default='ATR_Net', help='method')
    ...
    parser.add_argument('-num_descriptor', type=int, default=5, help='number of testing episodes after training')
